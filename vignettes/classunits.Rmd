...
plot(terr.sompam$sompam.rast[[2]], main = "Terrain Classification Units",
     type = "classes", col = hcl.colors(8, "spectral", rev = TRUE),
     mar = c(1.5, 2, 1.5, 2.5)
    )
```
...
channels) will have values closer to 8.
...
terr.stat <- zonal(terr.var$height, terr.cu, fun = mean)
...
plot(terr.cu, type = "classes", col = hcl.colors(8, "spectral"),
